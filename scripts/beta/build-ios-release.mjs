...
console.log('  1. Open apps/mobile-flutter/ios/Runner.xcworkspace in Xcode');
...
console.log('  Copy apps/mobile-flutter/ios/ExportOptions.plist.example → ExportOptions.plist');
